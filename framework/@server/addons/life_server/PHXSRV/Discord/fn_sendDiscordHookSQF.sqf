...
Function:
	DiscordEmbedBuilder_fnc_sendDiscordHookSQF
...
[
	...
	false
] call PHX_fnc_sendDiscordHookSQF;
...
[_webhookurl,_message,_username,_avatar,_tts,_embeds] call PHX_fnc_callDiscordExtension;
