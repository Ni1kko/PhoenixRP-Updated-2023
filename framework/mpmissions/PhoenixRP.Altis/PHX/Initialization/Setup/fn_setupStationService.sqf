...

{
    ...
    _pump addAction ["Deliver Petroleum", PHX_fnc_deliverPetrol, 1, 3, true, true, "", '_this distance _target < 5 && cursorObject isEqualTo _target && !(isNil "PHX_petrolDest")'];
    false
} count _altisPositions;
